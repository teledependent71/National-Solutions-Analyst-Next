...
import authorsPageInitialPathsB73b1Resource from '../../../resources/authors-page-initial-paths-b73b1'
import authorsPageInitialProps8c945Resource from '../../../resources/authors-page-initial-props-8c945'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPathsB73b1Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps8c945Resource({
    ...context?.params,
